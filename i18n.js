...
(function () {
  ...
  var PT = {
    ...
    'case.card.mp.desc': 'Senior Product Designer em uma plataforma de food tech com mais de 4M de pedidos por mês. Design system, produto de pedidos e fluxos assistidos por IA.',
    ...
    'mp.46': '↑ O Pedir.Delivery redesenhado, reconstruído para o mercado em que compete',
    'mp.47': 'Cardápio',
    ...
    'mp.63': '01 · Pedir.Delivery · Checkout',
    ...
    'mp.182': 'IA no fluxo de trabalho',
    ...
    'inc.88': 'Um colégio em São Paulo, 45 usuários, cerca de 60 estudantes e o fluxo completo do PEI em uso real. Observar isso nos disse o que precisava de retrabalho e trouxe à tona um problema que ainda não tínhamos formulado.',
    ...
    'inc.117': 'O teste',
    'inc.118': '45 usuários, 60 estudantes, uma escola real',
    'inc.107': 'O que descobrimos',
    'inc.108': 'Digitação repetida, e um documento ao qual ninguém voltava',
    'inc.109': 'Duas coisas apareceram. A primeira foi de fluxo: muitos professores dão aula de mais de uma matéria, então o mesmo estudante aparece em várias das contribuições deles, e eles redigitavam as mesmas observações de comportamento toda vez. Permitir que uma nova contribuição já trouxesse o que havia sido preenchido para aquele estudante cortou a repetição e mostrou quais outros fluxos dava para encurtar, devolvendo tempo para o que importa, escrever o PEI e definir objetivos.',
    'inc.112': 'A segunda foi retenção. O PEI deveria ser um documento vivo, mas o padrão real era outro: o professor gasta o esforço criando, depois apenas consulta, altera algo pontual ou repassa adiante. Essa rotina não exige acesso frequente, e as escolas acabavam usando a plataforma por um período em vez de continuamente. O problema não era o documento. Era que nada acontecia depois dele.',
    'inc.113': 'A resposta',
    'inc.114': 'De escrever um plano a acompanhar um estudante',
    'inc.115': 'Cada objetivo agora se desdobra em atividades com data, meta e status, então o progresso deixa de ser memória e vira registro: quem registrou o quê, quando e o quanto avançou. Gráficos e uma linha do tempo transformam esse registro em uma leitura do estudante ao longo do período letivo, que é exatamente o que a coordenação precisa para as reuniões e o professor precisa para decidir o próximo passo.',
    'inc.119': 'Isso mudou o motivo de voltar. A plataforma deixou de ser o lugar onde se escreve o PEI e passou a ser o lugar onde se acompanha o estudante, semana a semana. Gerenciar PEIs virou o ponto de partida, não o produto inteiro, e o uso pelas escolas se tornou contínuo.',
